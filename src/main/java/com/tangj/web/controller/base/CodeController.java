...
public class CodeController {
    ...
    public void yzm() throws IOException {
        ...
        // 将图像填充为白色
        gd.setColor(new Color(238, 238, 238));
        ...
        HttpServletRequest req = ApplicationContextHolder.getRequest();
        HttpServletResponse resp = ApplicationContextHolder.getResponse();
