package com.tangj.web.controller.client;
...
public class ClientInfoController extends BaseController{
	...
	@RequiresPermissions(values = "clientInfo:index")
	@RequestMapping(value = "" , method = RequestMethod.GET)
	public ModelAndView index(){
		return new ModelAndView("templates/clients/client/index");
	}
	@RequiresPermissions(values = "clientInfo:index")
	@ResponseBody
	...
	//添加
	@RequiresPermissions(values = "clientInfo:add")
	...
	//修改
	@RequiresPermissions(values = "clientInfo:edit")
